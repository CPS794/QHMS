    ...
    <div class="main container">
        ...
        <div class="row">
            ...
            <div class="col-md-6" align="center">
                <button type="button" class="btn btn-success" onclick="showEvaluate()">评价教师组</button>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/WebRoot/js/homework/homeworkAnswer.js"></script>
</html>
