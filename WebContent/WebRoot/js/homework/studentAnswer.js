...
function init() {
    $.ajax({
        ...
        data: "chapterId=" + chapter + "&studentId=" + student,
        dataType: "json",
...
function initPage(grade) {
    $('#answerChapterTitle').html(studentName + ' 同学 ' + chapterInfo.displayName + ': ' + grade + '分');
    $('#answerPanel').html('');
...
function goBack() {
    window.location = "scoreManage.action";
}
